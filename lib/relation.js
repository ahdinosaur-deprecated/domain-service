...
var RelatedService = Proto.extend({
  ...
  create: function (data, params) {
    ...
    return Related.createAsync(data, {}).then(function (related) {
      // get parent
      return Parent.getAsync(parentId, { depth: 0 }).then(function (parent) {
        // add related to parent
        parent[relation] = parent[relation].concat([related.id]);
        // update parent
        return Parent.updateAsync(parent.id, parent, {});
      });
    });
  },
